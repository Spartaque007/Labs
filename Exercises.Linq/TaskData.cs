...
namespace Exercises.Linq
{
    ...
    {
        public List<string> Fruits { get; } = new List<string>()
            {
                "Lemon", "Apple", "Orange", "Lime", "Watermelon", "Loganberry"
            };

        public List<int> MixedNumbers { get; } = new List<int>() { 15, 8, 21, 24, 32, 13, 30, 12, 7, 54, 48, 4, 49, 96 };
        ...
        public List<double> Purchases { get; } = new List<double>()
            {
                2340.29, 745.31, 21.76, 34.03, 4786.45, 879.45, 9442.85, 2454.63, 45.65
            };

        public List<int> wheresSquaredo = new List<int>()
            {
        ...
        new Customer(){ Name="Joe Landy", Balance=9_284_756.21, Bank="WF"},//WF"
        new Customer(){ Name="Meg Ford", Balance=487_233.01, Bank="BOA"},
        new Customer(){ Name="Peg Vale", Balance=7_001_449.92, Bank="BOA"},//BOA
        new Customer(){ Name="Mike Johnson", Balance=790_872.12, Bank="WF"},
        new Customer(){ Name="Les Paul", Balance=8_374_892.54, Bank="WF"},//WF
        new Customer(){ Name="Sid Crosby", Balance=957_436.39, Bank="FTB"},
        new Customer(){ Name="Sarah Ng", Balance=56_562_389.85, Bank="FTB"},//FTB
